...
const Service = ({ service }) => {
    ...
    return (
        <div className='flex flex-col w-10/12 p-8 pb-4 border-8 border-indigo-200 hover:border-indigo-400 hover:bg-indigo-100 transition-all service'>
            ...
            <button onClick={checkOutHandle} className='w-1/2 mt-5 py-1 font-semibold border-2 border-indigo-400 hover:border-indigo-500 hover:border-4 hover:scale-x-110'>Check Now</button>
        </div>
    );
};
