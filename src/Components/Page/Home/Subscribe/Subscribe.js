    ...
    return (
        <div className='block md:flex items-center justify-evenly my-5 md:my-10 p-5 md:p-20 bg-indigo-50'>
            <div>
                ...
                <input className='w-2/1 md:w-2/3 bg-indigo-300 placeholder-black outline-none font-semibold px-5 py-3 rounded-l-xl' type="email" placeholder='Enter Your Email' required/>
